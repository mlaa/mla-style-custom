<?php
/**
 * Template to use to create a new style plugin. Already has magic setup. Customize to suite need.
 * @package STYLE PLUGIN TEMPLATE
 * @version 1.1.1212018 iterated upon from the original mla style twitter plugin. first verison == 1.1.1212018
 */

class STYLE_PLUGIN_TEMPLATE {
	private $plugin_name = 'template';
	...
	/**
	 * @return bool|STYLE_PLUGIN_TEMPLATE|null
	 */
